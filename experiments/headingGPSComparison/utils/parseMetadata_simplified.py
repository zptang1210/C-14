        ...
        with open(self.filePath, 'r') as fin:
            ...
            while True:
                ...
                if cmdClass.cmd in parseMetadata.__DroneFlyingStatusLabel:
                    ...
                    if cmdClass.cmd == 'CENTER_POINT':
                        centerPoint_pattern = re.match(r'\(([-\d.]+),([-\d.]+)\)', cmdClass.rawParams[1])
                        centerPoint = float(centerPoint_pattern.group(2)), float(centerPoint_pattern.group(1))
